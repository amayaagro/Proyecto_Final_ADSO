...
<div class="card">
    <div class="content">
        <div class="title">
            <h2 id="Titulo"><strong>Modificar Datos Cultivo</strong><img src="../../Img/Logo.png" width="230"
        ...
        <div class="card-body">
            <form action="" method="post" class="form" enctype="multipart/form-data">
                ...
                <div class="mb-3">
                    ...
                    <input type="text" value="<?php echo $nombrecultivo; ?>" class="form-control"
                        name="nombredelcultivo" id="nombredelcultivo" aria-describedby="helpId"
