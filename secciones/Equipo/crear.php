...
<div class="card">
    <div class="content">
        <div class="title">
            <h2 id="Titulo"><strong>Registrar Equipo</strong><img src="../../Img/Logo.png" width="230" height="80"
                    align="right"></h2>
        </div>
        <div class="card-body">
            <form action="" method="post" class="form" enctype="multipart/form-data">
                ...
                <div class="mb-3">
                    ...
                    <input type="text" class="form-control" name="nombreequipo" id="nombreequipo" value="" required
                        aria-describedby="helpId" placeholder="Ingrese el nombre del equipo">
                </div>
                <div class="mb-3">
                ...
                <div class="mb-3">
                    ...
                    <input type="date" class="form-control" name="fechademantenimiento" id="fechademantenimiento"
                        aria-describedby="helpId" placeholder="">
                </div>
        </div>
        </br>
