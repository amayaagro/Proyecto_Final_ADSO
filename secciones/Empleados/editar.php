        ...
        <div class="card-body">
            <form action="" method="post" class="form" enctype="multipart/form-data">
                ...
                <div class="mb-3">
                    ...
                    <input type="number" value="<?php echo $documento ?>" class="form-control" name="documento" id="documento" min="0" aria-describedby="helpId" placeholder="Ingrese el documento">
                </div>
                <div class="mb-3">
                    <label for="nombrecompleto" class="form-label">Nombre Completo</label>
                    <input type="text" value="<?php echo $nombre ?>" class="form-control" name="nombrecompleto" id="nombrecompleto" aria-describedby="helpId" placeholder="Ingrese el nombre completo">
                </div>
                <div class="mb-3">
                    <label for="telefono" class="form-label">Teléfono</label>
                    <input type="number" value="<?php echo $telefono ?>" class="form-control" name="telefono" id="telefono" min="0" aria-describedby="helpId" placeholder="Ingrese el telefono">
                </div>
                <div class="mb-3">
                    <label for="fechadenacimiento" class="form-label">Fecha de Nacimiento</label>
                    <input type="date" value="<?php echo $fechadenacimiento ?>" class="form-control" name="fechadenacimiento" id="fechadenacimiento" aria-describedby="helpId" placeholder="Ingrese la fecha de nacimiento">
                </div>
                <div class="mb-3">
                    <label for="eps" class="form-label">EPS</label>
                    <input type="text" value="<?php echo $eps ?>" class="form-control" name="eps" id="eps" aria-describedby="helpId" placeholder="Ingrese la eps">
                </div>
                <div class="mb-3">
                    <label for="arl" class="form-label">ARL</label>
                    <input type="text" value="<?php echo $arl ?>" class="form-control" name="arl" id="arl" aria-describedby="helpId" placeholder="Ingrese la arl">
                </div>
                </br>
