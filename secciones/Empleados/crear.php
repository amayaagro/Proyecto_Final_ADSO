        ...
        <div class="card-body">
            <form action="" method="post" class="form" enctype="multipart/form-data">
                <div class="mb-3">
                    ...
                    <input type="number" class="form-control" name="documento" id="documento" value="" min="0" required aria-describedby="helpId" placeholder="Ingrese el documento">
                </div>
                <div class="mb-3">
                ...
                <div class="mb-3">
                    ...
                    <input type="number" class="form-control" name="telefono" id="telefono" value="" min="0" required aria-describedby="helpId" placeholder="Ingrese el telefono">
                </div>
                <div class="mb-3">
