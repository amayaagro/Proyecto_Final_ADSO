...
<div class="card">
    <div class="content">
        <div class="title">
            <h2 id="Titulo"><strong>Labores</strong><img src="../../Img/Logo.png" width="230" height="80" align="right">
            </h2>
        </div>
        <div class="card-body">
                    ...
                    <tbody>
                        ...
                        <tr class="">
                            ...
                            <td> <a id="editar" class="btn" title="Editar"
                                    href="editar.php?txtID=<?php echo $labor['Id']; ?>" role="button">Editar</a>
                                <a id="borrar" class="btn" title="Estado"
                                    href="javascript:borrar(<?php echo $labor['Id']; ?>);" role="button">Estado</a>
                            </td>
                        </tr>
                        <?php } ?>
                    </tbody>
