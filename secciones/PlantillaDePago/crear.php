        ...
        <div class="card-body">
            <form action="" method="post" class="form" enctype="multipart/form-data">
                ...
                <div class="mb-3">
                    ...
                    <input type="number" onChange="CalcularTotal()" class="form-control" name="sueldo" id="sueldo" value="" min="0" required aria-describedby="helpId" placeholder="Ingrese el valor neto">
                </div>
                <div class="mb-3">
                    <label for="descuento" class="form-label">Descuento</label>
                    <input type="number" onChange="CalcularTotal()" class="form-control" name="descuento" id="descuento" value="" min="0" required aria-describedby="helpId" placeholder="Ingrese el descuento">
                </div>
                <div class="mb-3">
                    <label for="valortotal" class="form-label">Valor a Pagar</label>
                    <input type="number" class="form-control" name="valortotal" id="valortotal" min="0" aria-describedby="helpId" placeholder="Ingrese el valor total">
                </div>
                </br>
