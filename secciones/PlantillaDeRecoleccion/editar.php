...
<div class="card">
    <div class="content">
        <div class="title">
            <h2 id="Titulo"><strong>Modificar Datos Planilla</strong><img src="../../Img/Logo.png" width="230" height="80" align="right"></h2>
        </div>
        <div class="card-body">
            <form action="" method="post" class="form" enctype="multipart/form-data">
                ...
                <div class="mb-3">
                    ...
                    <input type="date" value="<?php echo $FechaDeRecoleccion; ?>" class="form-control" name="fechaderecoleccion" id="fechaderecoleccion" aria-describedby="helpId" placeholder="">
                </div>
                <div class="mb-3">
                ...
                <div class="mb-3">
                    ...
                    <input type="number" value="<?php echo $KilosRecolectados; ?>" class="form-control" name="kilosrecolectados" id="kilosrecolectados" min="0" aria-describedby="helpId" placeholder="Kilos Recolectados">
                </div>
                <div class="mb-3">
                    <label for="jornalesderecoleccion" class="form-label">Jornales Empleados</label>
                    <input type="number" value="<?php echo $JornalesRecoleccion; ?>" class="form-control" name="jornalesderecoleccion" id="jornalesderecoleccion" min="0" aria-describedby="helpId" placeholder="Ingrese los jornales utilizados en la recolección">
                </div>
                <div class="mb-3">
                    <label for="valorneto" class="form-label">Valor Neto</label>
                    <input type="number" onChange="CalcularTotal()" value="<?php echo $ValorNeto; ?>" class="form-control" name="valorneto" id="valorneto" min="0" aria-describedby="helpId" placeholder="Ingrese el valor neto">
                </div>
                <div class="mb-3">
                    <label for="descuentos" class="form-label">Descuento</label>
                    <input type="number" onChange="CalcularTotal()" value="<?php echo $Descuentos; ?>" class="form-control" name="descuentos" id="descuentos" min="0" aria-describedby="helpId" placeholder="Ingrese el descuento">
                </div>
                <div class="mb-3">
                    <label for="total" class="form-label">Valor a Pagar</label>
                    <input type="number" value="<?php echo $Total; ?>" class="form-control" name="total" id="total" min="0" aria-describedby="helpId" placeholder="Ingrese el valor a pagar">
                </div>
                </br>
