...
<div class="card">
    <div class="content">
        <div class="title">
            <h2 id="Titulo"><strong>Planilla de Recolección</strong><img src="../../Img/Logo.png" width="230" height="80" align="right"></h2>
        </div>
        <div class="card-body">
            ...
            <div class="table-responsive-sm">
                <table id="tabla_id" class="display nowrap" style="width:100%">
                    ...
                    <div> <a href="../../secciones/PlantillaDeRecoleccion/reportePDF.php"><img src="../../Img/ImpresoraPDF.png" width="70" height="60" align="right" title="Exportar a PDF" href=""></a>
                    </div>
                    <tbody>
                        <?php foreach ($recoleccion as $recolector) { ?>
                            <tr class="">
                                ...
                                <?php if ($recolector['Estado'] == 0) { ?>
                                    <td>Inactivo</td>
                                <?php } ?>
                                <td><a id="editar" class="btn" title="Editar" href="editar.php?txtID=<?php echo $recolector['Id']; ?>" role="button">Editar</a>
                                    <a id="borrar" class="btn" title="Estado" href="javascript:borrar(<?php echo $recolector['Id']; ?>);" role="button">Estado</a>
                                </td>
                            </tr>
                        <?php } ?>
                    </tbody>
