        ...
        <div class="card-body">
            <form action="" method="post" class="form" enctype="multipart/form-data">
                ...
                <div class="mb-3">
                    ...
                    <input type="number" class="form-control" name="kilosrecolectados" id="kilosrecolectados" value="" required aria-describedby="helpId" placeholder="Kilos Recolectados">
                </div>
                <div class="mb-3">
                    <label for="jornalesderecoleccion" class="form-label">Jornales Empleados</label>
                    <input type="number" class="form-control" name="jornalesderecoleccion" id="jornalesderecoleccion" value="" required aria-describedby="helpId" placeholder="Ingrese los jornales utilizados en la recolección">
                </div>
                <div class="mb-3">
                    <label for="valorneto" class="form-label">Valor Neto</label>
                    <input type="number" onChange="CalcularTotal()" class="form-control" name="valorneto" id="valorneto" value="" required aria-describedby="helpId" placeholder="Ingrese el valor neto">
                </div>
                <div class="mb-3">
                    <label for="descuentos" class="form-label">Descuento</label>
                    <input type="number" onChange="CalcularTotal()" class="form-control" name="descuentos" id="descuentos" value="" required aria-describedby="helpId" placeholder="Ingrese el descuento">
                </div>
                <div class="mb-3">
                    <label for="total" class="form-label">Valor a Pagar</label>
                    <input type="number" class="form-control" name="total" id="total" aria-describedby="helpId" placeholder="Ingrese el valor total">
                </div>
                </br>
