...
<div class="card">
    <div class="content">
        <div class="title">
            <h2 id="Titulo"><strong>Modificar Herramienta</strong><img src="../../Img/Logo.png" width="230" height="80" align="right"></h2>
        </div>
        <div class="card-body">
            <form action="" method="post" class="form" enctype="multipart/form-data">
                ...
                <div class="mb-3">
                    ...
                    <input type="text" value="<?php echo $NombreHerramienta; ?>" class="form-control" name="nombreherramienta" id="nombreherramienta" aria-describedby="helpId" placeholder="Ingrese el nombre de la herramienta">
                </div>
                <div class="mb-3">
                    <label for="cantidad" class="form-label">Cantidad</label>
                    <input type="number" value="<?php echo $Cantidad; ?>" class="form-control" name="cantidad" id="cantidad" aria-describedby="helpId" placeholder="Ingrese la cantidad">
                </div>
                <div class="mb-3">
                ...
                <div class="mb-3">
                    ...
                    <input type="date" value="<?php echo $FechaDeReemplazo; ?>" class="form-control" name="fechadereemplazo" id="fechadereemplazo" aria-describedby="helpId" placeholder="">
                </div>
                </br>
