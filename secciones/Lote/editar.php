...
<div class="card">
    <div class="content">
        <div class="title">
            <h2 id="Titulo"><strong>Modificar Datos Lote</strong><img src="../../Img/Logo.png" width="230" height="80" align="right"></h2>
        </div>
        <div class="card-body">
            <form action="" method="post" class="form" enctype="multipart/form-data">
                ...
                <div class="mb-3">
                    ...
                    <input type="text" value="<?php echo $nombredelote; ?>" class="form-control" name="nombrelote" id="nombrelote" aria-describedby="helpId" placeholder="Ingrese el nombre del lote">
                </div>
                <div class="mb-3">
                    <label for="finca" class="form-label">Finca Asociada</label>
                    <select class="form-select form-select-sm" name="finca" id="finca">
                        <?php foreach ($fincas as $finca) { ?>
                            <option <?php echo ($FincaAsociada == $finca['id']) ? "selected" : ""; ?> value="<?php echo $finca['id']; ?>">
                ...
                <div class="mb-3">
                    ...
                    <select class="form-select form-select-sm" name="cultivo" id="cultivo">
                        <?php foreach ($cultivos as $siembra) { ?>
                            <option <?php echo ($Cultivo == $siembra['Id']) ? "selected" : ""; ?> value="<?php echo $siembra['Id']; ?>">
                ...
                <div class="mb-3">
                    ...
                    <input type="number" value="<?php echo $Tamano; ?>" class="form-control" name="tamaño" id="tamaño" min="0" aria-describedby="helpId" placeholder="Ingrese el tamaño del lote">
                </div>
                <div class="mb-3">
                    <label for="fechadesiembra" class="form-label">Fecha de Siembra</label>
                    <input type="date" value="<?php echo $FechaDeSiembra; ?>" class="form-control" name="fechadesiembra" id="fechadesiembra" aria-describedby="helpId" placeholder="">
                </div>
                </br>
