...
<div class="card">
    <div class="content">
        <div class="title">
            <h2 id="Titulo"><strong>Fincas</strong><img src="../../Img/Logo.png" width="230" height="80" align="right"></h2>
        </div>
        <div class="card-body">
                        ...
                        <?php foreach ($fincas as $finca) { ?>
                            <tr class="">
                                ...
                                <?php if ($finca['Estado'] == 0) { ?>
                                    <td>Inactivo</td>
                                <?php } ?>
                                <td> <a id="editar" class="btn" title="Editar" href="editar.php?txtID=<?php echo $finca['id']; ?>" role="button">Editar</a>
                                    <a id="borrar" class="btn" title="Estado" href="javascript:borrar(<?php echo $finca['id']; ?>);" role="button">Estado</a>
                                </td>
                            </tr>
                        <?php } ?>
                    </tbody>
