...
<div class="card">
    <div class="content">
        <div class="title">
            <h2 id="Titulo"><strong>Modificar Datos Insumo</strong><img src="../../Img/Logo.png" width="230"
        ...
        <div class="card-body">
            <form action="" method="post" class="form" enctype="multipart/form-data">
                ...
                <div class="mb-3">
                    ...
                    <input type="date" value="<?php echo $fechadeinventario; ?>" class="form-control"
                ...
                <div class="mb-3">
                    ...
                    <input type="text" value="<?php echo $nombreinsumo; ?>" class="form-control" name="nombreinsumo"
                        id="nombreinsumo" aria-describedby="helpId" placeholder="Ingrese el nombre del insumo">
                </div>
                <div class="mb-3">
                    <label for="ingredienteactivo" class="form-label">Ingrediente Activo</label>
                    <input type="text" value="<?php echo $ingredienteactivo; ?>" class="form-control"
                        name="ingredienteactivo" id="ingredienteactivo" aria-describedby="helpId"
                        placeholder="Ingrese el ingrediente activo">
                </div>
                <div class="mb-3">
                    <label for="unidad" class="form-label">Unidad</label>
                    <input type="text" v value="<?php echo $unidad; ?>" class="form-control" name="unidad" id="unidad"
                        aria-describedby="helpId" placeholder="Ingrese la unidad">
                </div>
                <div class="mb-3">
                    <label for="cantidadenbodega" class="form-label">Cantidad</label>
                    <input type="number" value="<?php echo $cantidadenbodega; ?>" class="form-control"
                        name="cantidadenbodega" id="cantidadenbodega" aria-describedby="helpId"
                        placeholder="cantidad en bodega">
                </div>
                <div class="mb-3">
                    <label for="fechadecompra" class="form-label">Fecha de Compra</label>
                    <input type="date" value="<?php echo $fechadecompra; ?>" class="form-control" name="fechadecompra"
                        id="fechadecompra" aria-describedby="helpId" placeholder="">
                </div>
                <div class="mb-3">
                    <label for="fechadevencimiento" class="form-label">Fecha de Vencimiento</label>
                    <input type="date" value="<?php echo $fechadevencimiento; ?>" class="form-control"
                        name="fechadevencimiento" id="fechadevencimiento" aria-describedby="helpId" placeholder="">
                </div>
                </br>
