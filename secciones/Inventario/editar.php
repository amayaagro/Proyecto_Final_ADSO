...
<div class="card">
    <div class="content">
        <div class="title">
            <h2 id="Titulo"><strong>Modificar Datos Insumo</strong><img src="../../Img/Logo.png" width="230" height="80" align="right"></h2>
        </div>
        <div class="card-body">
            <form action="" method="post" class="form" enctype="multipart/form-data">
                ...
                <div class="mb-3">
                    ...
                    <input type="number" value="<?php echo $cantidadenbodega; ?>" class="form-control" name="cantidadenbodega" id="cantidadenbodega" min="0" aria-describedby="helpId" placeholder="cantidad en bodega">
                </div>
                <div class="mb-3">
